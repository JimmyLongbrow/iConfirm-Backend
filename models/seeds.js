...
const printReport = async () => {
  ...
  rosterCheck.forEach( f => {
    console.log(
      green, `${f.rosterNumber}:`, yellow, `${f.origin} -> ${f.destination}`,
  ...
  .populate({
    path: 'shifts.roster', // Mongoose populates this association
    // model: 'Roster'
  });
